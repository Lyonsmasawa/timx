    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_unit', models.DecimalField(decimal_places=2, max_digits=10)),
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='item_movements', to='item.item')),
